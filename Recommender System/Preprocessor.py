...
def preprocess():
    ...
    for user_id in user_id_list:
        ...
        processed_main_dataframe = pd.concat([processed_main_dataframe, unique_rows])
        # processed_main_dataframe.append(unique_rows)
        ...
        for item_id in user_item_id_list:
            ...
            processed_main_dataframe = pd.concat([processed_main_dataframe, pd.DataFrame([processed_item_row])], ignore_index=True)
